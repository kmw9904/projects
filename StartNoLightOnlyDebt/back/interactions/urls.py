...
urlpatterns = [
    ...
    path('credit/<str:product_id>/comments/<int:comment_id>/delete/', views.delete_credit_comment, name='delete_credit_comment'),
    ...
    path('jeonse/<str:product_id>/comments/<int:comment_id>/delete/', views.delete_jeonse_comment, name='delete_jeonse_comment'),
    ...
    path('mortgage/<str:product_id>/comments/<int:comment_id>/delete/', views.delete_mortgage_comment, name='delete_mortgage_comment'),
]
